  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh", color: "#111", fontFamily: "monospace" }}>
      ...
      <div style={{ borderBottom: "1px solid #eee", padding: "20px 32px" }}>
        ...
        <h1 style={{ fontFamily: "'Georgia', serif", fontSize: 28, fontWeight: 400, color: "#111", margin: "0 0 4px", letterSpacing: "-0.02em" }}>Claims for damages filed against LAPD and LASD</h1>
        <div style={{ fontFamily: "monospace", fontSize: 10, color: "#bbb" }}>Search hundreds of documents by names, neighborhoods or other keywords. Last updated April 9, 2026.</div>
        <div style={{ marginTop: 10, paddingTop: 10, borderTop: "1px solid #eee" }}>
          <p style={{ fontFamily: "monospace", fontSize: 10, color: "#666", letterSpacing: "0.06em", marginBottom: 4, marginTop: 0 }}>
            Source: Obtained via California Public Records Act requests · Data compiled manually by Luke Harold · Coding by Claude · The documents contain allegations; some claims may not yet have been adjudicated or otherwise settled.
          </p>
